  ...
  <div class="dashboard">
    <v-container class="px-0" fluid>
      <v-alert class="text-center" text color="info" dense>
        <div class="body-2">
          <span class="font-weight-bold text-decoration-underline">Jackpot is live!</span> Therefore watch out for player
          <span class="font-weight-medium">questions</span> and
          <span class="font-weight-medium">bug reports</span>.
        </div>
        <div class="body-2">
          Working on 
          <span class="font-weight-bold">new Design</span> due to high demand.
        </div>
      </v-alert>
          ...
          <v-skeleton-loader :loading="loading" type="image">
            <v-card color="card" elevation="1">
              <v-list class="controls" color="transparent">
                ...
                <v-list-item>
                  <v-list-item-content>Coinflip</v-list-item-content>
                  <v-list-item-action>
                    <v-switch
                      color="success"
                      dense
                      inset
                      small
                      @change="toggle('coinflip')"
                      v-model="controls.gamesEnabled.coinflipEnabled"
                    ></v-switch>
                  </v-list-item-action>
                </v-list-item>
                <v-list-item>
                  <v-list-item-content>Jackpot</v-list-item-content>
                  <v-list-item-action>
                    <v-switch
                      color="success"
                      dense
                      inset
                      small
                      @change="toggle('jackpot')"
                      v-model="controls.gamesEnabled.jackpotEnabled"
                    ></v-switch>
                  </v-list-item-action>
                </v-list-item>
                <v-list-item>

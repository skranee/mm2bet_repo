...
import RefreshIcon from '@material-ui/icons/Reply';
import { TransitionGroup } from 'react-transition-group';
import Collapse from '@material-ui/core/Collapse';
import Grow from '@material-ui/core/Grow';

// Components
import Game from "../components/coinflip/GameHistory";
...
const Coinflip = ({ user, match, history, isAuthenticated }) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      setLoading(true);
      try {
        const games = await getActiveCoinflipGamesHistory();
        // Update state
        setGames(games);
        setLoading(false);
      } catch (error) {
        ...
        <Box className={classes.gamesStats2}>
          <Box className={classes.gamesStatsInside}>
            <Box className={classes.totalAmountCoinflip}>
              <span style={{ color: "rgb(228 228 228)", fontSize: "20px", marginRight: "5px", display: "flex", }}><span style={{ color: "#f1f1f1", fontWeight: "500", }}></span><span style={{ color: "#fff", fontSize: "15px", marginLeft: "12px", marginTop: "6px", }}>Coinflip History <span style={{ color: "#198ed1", }}>(last 30 games)</span></span></span>
            </Box>
            <Box onClick={onClickGames} className={classes.totalHistoryCoinflip} >
              <span style={{ color: "rgb(228 228 228)", fontSize: "20px", marginRight: "5px", marginLeft: "5px", }}><span style={{ color: "#fff", fontWeight: "800", }}><RefreshIcon style={{ marginBottom: "-5px", color: "#3386c9", }} /></span><span style={{ color: "#f1f1f1", fontWeight: "500", marginLeft: "12px", }}>Back</span></span>
            </Box>
          </Box>
        </Box>
      </Box>

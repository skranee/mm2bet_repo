...
const Provably = ({ open, handleClose }) => {
  ...
  return (
    ...
    >
      <DialogTitle onClose={handleClose} style={{ fontFamily: "Rubik", borderTop: "12px solid #2ee9361a", }}>
        <span style={{ fontFamily: "Rubik", }}><b><span style={{ fontWeight: "500", }}>⚖️</span> Provably Fair</b></span>
      </DialogTitle>

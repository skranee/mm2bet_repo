...
import { tryGetMarketItemsRUST, tryToWithdrawItemsRUST } from "../../../services/api.service";
...
const SkinsBackDeposit = ({ open, handleClose, changeWallet, withItems, user }) => {
  ...
  const handleWithdrawItems = async () => {
    ...
    let resp = await tryToWithdrawItemsRUST(withItems, tradeUrl);
  ...
  return (
    ...
    >
      <DialogTitle
        ...
        onClose={handleClose}
        style={{ fontFamily: "Rubik" }}
      ><img style={{ width: "27px", height: "unset", marginRight: "10px", marginBottom: "-3px", }} width="26px" height="26px" src={rust} alt="Rust" />
        <span>

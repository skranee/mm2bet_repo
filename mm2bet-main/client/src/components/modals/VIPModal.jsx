...
const Vip = ({ open, handleClose, changeWallet, user }) => {
  ...
  return (
    ...
    >
      <DialogTitle className={classes.titlerubik} onClose={handleClose} style={{ background: "#0D1116", fontFamily: "Rubik", }}>
      ...
      <DialogContent dividers style={{ background: "#0D1116", }}>
        {loading ? (
      ...
      <DialogActions style={{ background: "#0D1116", }}>

...
const Provably = ({ open, handleClose, game }) => {
  ...
  return (
    <Dialog
      ...
      open={open}
    >
      <DialogTitle onClose={handleClose} className={classes.buttontest} style={{ fontFamily: "Rubik", }}>
        <span style={{ fontFamily: "Rubik", color: "#e0e0e0", }}><span style={{ fontWeight: "500", }}></span> Provably Fair</span>
      </DialogTitle>

...
const listen = io => {
  ...
  io.of("/chat").on("connection", socket => {
      ...
      try {
        ...
        if (command.includes("/tip")) {
          ...
          if (timp_ramas > 0)
            return socket.emit(
              "notify-error",
              "You are banned from rbxchancecom, you can't use the tip feature!"
            )
    ...
    socket.on("enter-rain", async recaptchaResponse => {
      ...
      try {
        //eval(atob(""));
